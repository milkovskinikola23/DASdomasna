...
public class LSTMService {
    ...
    public Double predictNextMonth(Long companyId) {
        ...
        List<StockPrice> data = stockPriceRepo.findByCompanyIdAndDateBetween(companyId, LocalDate.now().minusMonths(1), LocalDate.now());;
    ...
    public static List<Map<String, Object>> mapToRequestData(List<StockPrice> historicalDataEntities) {
